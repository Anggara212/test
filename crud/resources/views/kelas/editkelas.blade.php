...
@section('content')
<div class="container">
    <h1 class="text-center mb-4 pt-4">Edit Kelas</h1>
                ...
                <div class="card-body" style="width: 90%">
                    <form  method="POST" action="/updatedatakelas/{{$data->id}}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="namakelas" value="{{$data->namakelas}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="walikelas" class="form-control" id=""
                                aria-describedby="emailHelp" value="{{$data->walikelas}}">
